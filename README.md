...
###### VLM-based
1. \[arXiv 2025\] Unlocking the Capabilities of Vision-Language Models for Generalizable and Explainable Deepfake Detection [Paper](https://arxiv.org/pdf/2503.14853)
2. \[arXiv 2025\] TruthLens: A Training-Free Paradigm for DeepFake Detection [Paper](https://arxiv.org/pdf/2503.15342)
3. \[CVPR 2025\] Towards General Visual-Linguistic Face Forgery Detection [Paper](https://arxiv.org/pdf/2502.20698)
4. \[arXiv 2025\] Knowledge-Guided Prompt Learning for Deepfake Facial Image Detection [Paper](https://arxiv.org/pdf/2501.00700)
5. \[arXiv 2025\] Towards Interactive Deepfake Analysis [Paper](https://arxiv.org/pdf/2501.01164)
6. \[arXiv 2024\] A Large-scale Interpretable Multi-modality Benchmark for Facial Image Forgery Localization [Paper](https://arxiv.org/pdf/2412.19685)
7. \[arXiv 2024\] Nearly Solved? Robust Deepfake Detection Requires More than Visual Forensics [Paper](https://arxiv.org/abs/2412.05676)
...
20. \[ECCV 2024\] Common Sense Reasoning for Deepfake Detection [Paper](https://arxiv.org/abs/2402.00126)
